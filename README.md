...
If you are running in Codespaces or a remote container, bind to all interfaces and set the port:

```bash
streamlit run app.py --server.address 0.0.0.0 --server.port 8501
```

The command line interface remains available for scripting and automation.
